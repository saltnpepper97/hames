...
This directory is the authoritative build plan for Hames. M0 through M5 are
implemented; M6 is the next execution phase. Later milestones preserve the design
