...
report to luna-reviewer for independent inspection. Wait for its verdict.
...
Luna findings to sol-finisher. Sol must independently review and finish justified work.
4. If Sol fails or is BLOCKED, stop. Otherwise have luna-reviewer verify its finishing pass
once, then return the final report to the human. At most four child calls in the whole pass.
